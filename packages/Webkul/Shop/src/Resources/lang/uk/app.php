    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'topbar'        => [
                            'delivery'     => 'Доставка по всій Україні за 24–48 годин',
                            'guarantee'    => 'Оригінальна продукція • 14 днів на повернення',
                            'search-btn'   => 'Знайти',
                            'search-placeholder' => 'Пошук по каталогу…',
                            'top-sales'    => 'Топ‑продажі',
                            'new-items'    => 'Новинки',
            ...
            'footer' => [
                ...
                'whats-new'              => 'Що нового',
                'store-description'      => 'Магазин кальянів, тютюну та аксесуарів. Працюємо по всій Україні.',
                'contact-title'          => 'Ми на зв\'язку',
                'working-hours'          => 'Пн–Нд 10:00–20:00',
