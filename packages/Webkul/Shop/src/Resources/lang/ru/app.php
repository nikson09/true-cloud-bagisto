    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'wishlist'      => 'Избранное',
                        'topbar'        => [
                            'delivery'     => 'Доставка по всей Украине за 24–48 часов',
                            'guarantee'    => 'Оригинальная продукция • 14 дней на возврат',
                            'search-btn'   => 'Найти',
                            'search-placeholder' => 'Поиск по каталогу…',
                            'top-sales'    => 'Топ‑продажи',
                            'new-items'    => 'Новинки',
            ...
            'footer' => [
                ...
                'store-description'      => 'Магазин кальянов, табака и аксессуаров. Работаем по всей Украине.',
                'contact-title'          => 'Мы на связи',
