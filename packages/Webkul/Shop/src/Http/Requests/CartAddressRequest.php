...
class CartAddressRequest extends FormRequest
{
    ...
    private function mergeAddressRules(string $addressType): void
    {
        $this->mergeWithRules([
            ...
            "{$addressType}.address"      => ['array'],
            "{$addressType}.area"         => ['required', 'string'],
            "{$addressType}.city"         => ['required', 'string'],
            "{$addressType}.warehouse"    => ['required', 'string'],
            "{$addressType}.country"      => ['required', 'string', 'in:UA'],
            "{$addressType}.state"        => ['nullable'],
            "{$addressType}.postcode"     => [new PostCode],
