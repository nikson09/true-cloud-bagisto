...
return [
        ...
        'orders' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'nova-poshta-area' => 'Область Нової Пошти',
                    'nova-poshta-warehouse' => 'Відділення Нової Пошти',
            ...
            'view' => [
                ...
                'complete'                       => 'Завершити Замовлення',
                'complete-msg'                   => 'Ви впевнені, що хочете завершити це замовлення? Це автоматично створить рахунок-фактуру та відвантаження.',
                'complete-success'               => 'Замовлення успішно завершено. Рахунок-фактура та відвантаження створені.',
                'complete-error'                 => 'Помилка при завершенні замовлення',
                'complete-error-status'          => 'Замовлення може бути завершено тільки зі статусом "Обробка"',
                'canceled'                       => 'Скасовано',
                'channel'                        => 'Канал',
                'closed'                         => 'Закрито',
                ...
                'nova-poshta-area'               => 'Область Нової Пошти',
                'nova-poshta-city'               => 'Місто Нової Пошти',
                'nova-poshta-info'               => 'Інформація Нової Пошти',
                'nova-poshta-warehouse'          => 'Відділення Нової Пошти',
    ...
    'marketing' => [
        'communications' => [
            ...
            'email-broadcast' => [
                'title' => 'Розсилка Email',
                'content' => 'Контент',
                'recipients' => 'Отримувачі',
                'subject' => 'Тема',
                'subject-placeholder' => 'Введіть тему листа',
                'message' => 'Повідомлення',
                'message-placeholder' => 'Введіть текст повідомлення тут...',
                'recipient-type' => 'Тип отримувача',
                'select-recipient-type' => 'Оберіть тип отримувача',
                'customer-group' => 'Група клієнтів',
                'hello' => 'Привіт',
                'single-email' => 'Один Email',
                'select-group' => 'Оберіть групу клієнтів',
                'email-address' => 'Адреса Email',
                'email-placeholder' => 'Введіть адресу email',
                'customers-in-group' => 'Клієнтів у групі',
                'send-email' => 'Відправити Email',
                'sending' => 'Відправка',
                'send-success' => 'Email успішно відправлено! Відправлено: :sent, Не вдалося: :failed',
                'send-error' => 'Не вдалося відправити email. Спробуйте ще раз.',
                'validation-error' => 'Будь ласка, перевірте форму на помилки.',
                'no-recipients' => 'Не знайдено отримувачів за обраними критеріями.',
                'dear' => 'Шановний(а)',
                'thank-you' => 'Дякуємо',
                'email-footer' => 'Цей email було відправлено з вашого магазину.',
    ...
    'components' => [
        'layouts' => [
            ...
            'sidebar' => [
                ...
                'discount'                 => 'Знижка',
                'email-broadcast'          => 'Розсилка Email',
