    ...
    'sales' => [
        'orders' => [
            ...
            'view' => [
                ...
                'complete'                       => 'Готово',
                'complete-msg'                   => 'Вы уверены, что хотите завершить этот заказ? Это автоматически создаст счет-фактуру и отгрузку.',
                'complete-success'               => 'Заказ успешно завершен. Счет-фактура и отгрузка созданы.',
                'complete-error'                 => 'Ошибка при завершении заказа',
                'complete-error-status'          => 'Заказ может быть завершен только из статуса "Обработка"',
                'canceled'                       => 'Отменен',
                'channel'                        => 'Канал',
                'closed'                         => 'Закрыт',
